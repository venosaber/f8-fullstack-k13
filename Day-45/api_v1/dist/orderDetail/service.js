...
let OrderDetailService = class OrderDetailService extends service_1.BaseService {
    orderDetailRepository;
    columns = ['id', 'order_id', 'product_id', 'price', 'quantity', 'amount'];
...
exports.OrderDetailService = OrderDetailService = __decorate([
    ...
    __param(0, (0, common_1.Inject)('ORDER_DETAIL_REPOSITORY')),
