              ...
              <Box>
                ...
                <Box sx={{display: 'flex', alignItems: 'flex-end', mt: 2, gap: '10px'}}>
                  ...
                  <Box sx={{display: {xs: 'none', md: 'flex'}, ml: 'auto'}}>
                    <Avatar sx={{bgcolor: '#6c1b9a', width: 36, height: 36}}>B</Avatar>
                    <Avatar sx={{bgcolor: '#00bcd4', ml: -1, width: 36, height: 36}}>PD</Avatar>
                    <Avatar sx={{bgcolor: '#9c27b0', ml: -1, width: 36, height: 36}}>TB</Avatar>
                  </Box>
                </Box>
